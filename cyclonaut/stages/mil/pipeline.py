...
from cyclonaut.core.types import BatchClassificationResult, ClassificationResult, EstrousStage
from cyclonaut.stages.mil.encoder import PatchEncoder, resolve_device
